...
Ce workspace est le Jarvis personnel de Tan. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Tan et je vis à Paris. Je suis entrepreneur dans le domaine de l'IA depuis février 2026, fondateur de la société NOVAËN, et je propose du développement d'agents IA et de la formation en IA à des clients B2B.

Mes objectifs prioritaires actuels sont de vivre de mon activité (3 000 € de CA mensuel), signer mes premiers clients et développer mon audience LinkedIn.

À long terme, je veux construire une activité stable et libre (travailler de partout) avec un portfolio de clients conséquent.

Le domaine où j'ai besoin du plus d'aide en ce moment : la stratégie business.
...
├── .env                         # Clés d'API réelles (jamais commitées)
...
├── livrables/
│   ├── sites-web/               # Sites internet produits
│   └── applications/            # Outils, scripts, automatisations produits
├── .claude/
│   ├── commands/
...
| `livrables/` | Outputs : tout ce que Claude produit pour toi |
| `livrables/sites-web/` | Sites internet produits |
| `livrables/applications/` | Outils, scripts et automatisations produits |
...
**Règle d'or inputs/outputs :** ce qui vient de toi va dans `context/import/`, ce que Claude produit va dans `livrables/`.
